# number_midi script 
# snagged from: @https://gist.github.com/devxpy/063968e0a2ef9b6db0bd6af8079dad2a
# written by: https://gist.github.com/devxpy
...
OCTAVES = list(range(11)) # grid  = Notes x Octaves = 132
